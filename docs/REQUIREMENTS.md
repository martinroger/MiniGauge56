...
### Out of Scope
- Direct modifications to external managed components (`managed_components/twai_daemon/`, `managed_components/binocan/`, etc.), or `components/racebox_ble/`, `components/racebox_twai/`.
...
| **REQ-BMWP-01** | BMWP2000 Component Integration | Manage and link `bmwp2000` v1.2.0 component via ESP-IDF Component Manager. |
...
| **REQ-CAN-03** | [`managed_components/twai_daemon/src/twai_daemon.cpp`](../managed_components/twai_daemon/src/twai_daemon.cpp) | `twai_new_node_onchip()` | Unmodified component configuration |
...
| **REQ-CAN-05** | [`managed_components/twai_daemon/Kconfig`](../managed_components/twai_daemon/Kconfig)<br>[`managed_components/twai_daemon/src/twai_daemon.cpp`](../managed_components/twai_daemon/src/twai_daemon.cpp) | `CONFIG_CAN_ENABLE_LOOPBACK`, `enable_loopback` | Hardware loopback self-reception review |
| **REQ-CAN-06** | [`main/main.cpp`](../main/main.cpp)<br>[`managed_components/binocan/src/binocan.h`](../managed_components/binocan/src/binocan.h) | `BINOCAN_DBG_ITF_SPEED_FRAME_ID`, `binocan_dbg_itf_speed_unpack()` | CAN signal decoding logic review |
...
| **REQ-BMWP-01** | [`main/idf_component.yml`](../main/idf_component.yml) | `bmwp2000`, `v1.2.0` | Dependency resolution & compilation |
